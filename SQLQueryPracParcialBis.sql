...
INSERT INTO PVENTA VALUES (1,1,GETDATE(),11000)
INSERT INTO PVENTA VALUES (1,2,GETDATE()+31,12000)
INSERT INTO PVENTA VALUES (2,1,GETDATE()+62,13000)
INSERT INTO PVENTA VALUES (2,2,GETDATE()+62,9000)
INSERT INTO PVENTA VALUES (3,1,GETDATE()+93,11000)
INSERT INTO PVENTA VALUES (3,2,GETDATE()+31,7000)
INSERT INTO PVENTA VALUES (3,3,GETDATE()+60,8000)
INSERT INTO PVENTA VALUES (1,1,GETDATE()+94,3000)
INSERT INTO PVENTA VALUES (1,2,GETDATE()+3,9000)
INSERT INTO PVENTA VALUES (2,1,GETDATE()+6,1000)
INSERT INTO PVENTA VALUES (2,2,GETDATE()+2,3000)
INSERT INTO PVENTA VALUES (3,1,GETDATE()+105,1000)
INSERT INTO PVENTA VALUES (3,2,GETDATE()+31,7500)
INSERT INTO PVENTA VALUES (3,3,GETDATE()+68,8000)
INSERT INTO PVENTA VALUES (1,1,GETDATE()+157,3000)
INSERT INTO PVENTA VALUES (1,2,GETDATE()+39,2000)
INSERT INTO PVENTA VALUES (2,1,GETDATE()+183,500)

SELECT * FROM PVENTA

CREATE VIEW CUMPLEN AS
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 1
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 2
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 3
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 4
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 5
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 6
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 7
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 8
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 9
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 10
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 11
UNION
SELECT nroCadena,nroSucursal 
FROM PVENTA
WHERE total > 10000 AND MONTH(fecha) = 12

SELECT * FROM CUMPLEN

CREATE VIEW PROV_SUCUR AS
SELECT P.nroProvincia, S.nroCadena, S.nroSucursal
FROM PSUCURSAL AS S JOIN PDOMICILIO AS D ON S.nroDomicilio = D.nroDomicilio JOIN PLOCALIDAD AS L
ON l.nroLocalidad = D.nroLocalidad JOIN PPROVINCIA AS P ON P.nroProvincia = L.nroProvincia

CREATE VIEW PROV_SUCUR_VAL AS
SELECT PS.nroProvincia, CU.nroCadena, CU.nroSucursal
FROM PROV_SUCUR AS PS JOIN CUMPLEN CU ON 
(PS.nroCadena = CU.nroCadena AND PS.nroSucursal = CU.nroSucursal)

CREATE VIEW FALSAS AS
SELECT *
FROM PROV_SUCUR
EXCEPT
SELECT * 
...
INSERT INTO PVENTA VALUES (4,4,GETDATE(),1000)
INSERT INTO PVENTA VALUES (4,4,GETDATE()+10,2000)
INSERT INTO PVENTA VALUES (4,4,GETDATE()+20,3000)
INSERT INTO PVENTA VALUES (4,4,GETDATE()+30,6000)
INSERT INTO PVENTA VALUES (4,4,GETDATE()+40,8000)
INSERT INTO PVENTA VALUES (4,4,GETDATE()+50,10000)
INSERT INTO PVENTA VALUES (4,5,GETDATE(),1000)
INSERT INTO PVENTA VALUES (4,5,GETDATE()+10,2000)
INSERT INTO PVENTA VALUES (4,5,GETDATE()+20,3000)
INSERT INTO PVENTA VALUES (4,5,GETDATE()+30,6000)
INSERT INTO PVENTA VALUES (5,4,GETDATE(),8000)
INSERT INTO PVENTA VALUES (5,4,GETDATE()+50,10000)
INSERT INTO PVENTA VALUES (5,5,GETDATE(),8000)
INSERT INTO PVENTA VALUES (5,5,GETDATE()+50,10000)
INSERT INTO PVENTA VALUES (6,6,GETDATE(),6321)

SELECT nroCadena, nroSucursal, MONTH(fecha) as MES, SUM(total) as TOTAL
FROM PVENTA 
WHERE MONTH(fecha) = 3
GROUP BY nroCadena,nroSucursal, MONTH(fecha)
UNION ALL
SELECT nroCadena, nroSucursal, MONTH(fecha) as MES, SUM(total) as TOTAL
FROM PVENTA 
WHERE MONTH(fecha) = 4
